...
PlannerApp.controller('PlannerCtrl', function (PlannerFactory, apiTestBroadcastService, $scope, $q) {    

    $scope.$on('handleApiRequestListBroadcast', function () {
        $scope.ApiRequestList = apiTestBroadcastService.globalBroadcast.ApiRequestList;
