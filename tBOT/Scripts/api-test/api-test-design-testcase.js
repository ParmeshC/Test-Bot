...
DesignTestCaseApp.controller('DesignTestCaseCtrl', function (DesignTestCaseAppFactory, apiTestBroadcastService, $scope) {

    $scope.$on('handleDesignTestTemplateBroadcast', function () {
        $scope.DesignTestTemplate = apiTestBroadcastService.sharedObjects.DesignTestTemplate;
    });
